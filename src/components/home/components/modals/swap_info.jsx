  ...
  return (
    <div className='swap_info_modal'>
      <div className='swap_info_modal__container'>
        <p className='swap_info_modal__title'>
          The fuse ecosystem round is focused on offering the communty the{' '}
          <br />
          control of voltage. The volt tokens will have voing power and much
          more.
        </p>
        ...
        <div className='swap_info_modal__actions'>
          <a
            ...
            target='_blank'
            href='https://medium.com/fusenet/one-for-all-and-all-for-one-%EF%B8%8F-843f11b779f2'
            className='link'
          >
