  ...
  return (
    <section className='section_2'>
      ...
      <div className='subtitle'>
        Imagine being in full control of your finances while earning the highest
        interest <br /> rate to date. Voltage is a non-custodial platform that
        brings cutting edge financial <br /> tools to your fingertips.
      </div>
      ...
      <div className='stores'>
        <a
          ...
          target='_blank'
          href='https://get.fuse.cash/mrxn/dfb1a810'
        >
          {' '}
          <img src={google} />
        </a>
