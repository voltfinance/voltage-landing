...
const VoltSaleCard = () => {
  ...
  <>
   ...
   <img src={voltInfo} width={'685px'}/>
        <a href='https://docs.fuse.io' style={{textAlign: 'right',}}> <img src={docs} style={{marginRight:'8px'}} />Voltage Docs →</a>
        </div>
      ...
      <div className='info' onClick={openModal}><span>More Info <img src={info} /></span> </div> 
    </div>
  </>
