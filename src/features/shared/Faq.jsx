  ...
  items = [
    {
      ...
      a: `Focusing on reducing friction for non-experienced users, the Volt App provides a seamless DeFi experience on mobile devices. Non-custodial and without fees, the Volt App is the best way to interact with DeFi for beginners.
      `,
    },
    {
    ...
    },
    {
      ...
      a: `Read more about VOLT tokenomics in our  <a className="faq__link" target="_blank" href="https://docs-voltage.gitbook.io/voltage/tokenomics">docs.</a>`,
    },
    {
    ...
    },
    {
      ...
      <br></br>
      Check out our docs <a className="faq__link" target="_blank" href="https://docs-voltage.gitbook.io/voltage/audits">link</a>.
